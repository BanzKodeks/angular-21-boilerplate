    ...
    intercept(
        ...
        function refreshToken() {
            ...
            account.refreshTokens =
                account.refreshTokens.filter((x: any) => x !== refreshToken);
        ...
        function register() {
            ...
            setTimeout(() => {
               ...
               const verifyUrl =
                    `${location.origin}/#/account/verify-email?token=${account.verificationToken}`;
        ...
        function forgotPassword() {
            ...
            setTimeout(() => {
                ...
                const resetUrl =
                    `${location.origin}/account/reset-password?token=${account.resetToken}`;
        ...
        function getAccountById() {
            ...
            const account =
                accounts.find(x => x.id === idFromUrl());
        ...
        function deleteAccount() {
            ...
            accounts =
                accounts.filter(x => x.id !== idFromUrl());
        ...
        function currentAccount() {
            ...
            const jwtToken =
                JSON.parse(atob(authHeader.split('.')[1]));

            const tokenExpired =
                Date.now() > (jwtToken.exp * 1000);
        ...
        function generateRefreshToken() {
            ...
            document.cookie =
                `fakeRefreshToken=${token}; expires=${expires}; path=/`;
