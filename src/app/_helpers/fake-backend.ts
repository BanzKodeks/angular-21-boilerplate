...
export class FakeBackendInterceptor implements HttpInterceptor {
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>> {
        ...
        function register() {
            ...
            if (account.find((x: any) => x.emaill === account.email)) {
                
                setTimeout(() => {
                    alertService.info(`
                        <h4>Email Alreay Registered</h4>
                        <p>Your email ${account.email} is already registered.</p>
                        <p>If you don't know your password please visit the <a href="${location.origin}/account/forgot-password">forgot password</a> page.</p>
                        <div><strong>NOTE:</strong> The fake baackend displayed this "email" so you can test without an api. A real backend would a real email</div>
                        `,{ autoClose: false });
                }, 1000);
            ...
            account.verficationToken = new Date().getTime().toString();
